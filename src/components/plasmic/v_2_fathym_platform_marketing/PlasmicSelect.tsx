...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: qabPCJ9-LYT4lc/component
import Select__Option from "../../Select__Option"; // plasmic-import: SKxR7mjLnG7BvA/component
import Select__OptionGroup from "../../Select__OptionGroup"; // plasmic-import: z22IV59uvDRM56/component
...
import * as sty from "./PlasmicSelect.module.css"; // plasmic-import: e1WdP4WwrwenvD/css

import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: NlNua8Y3CBagWM/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: YnClxBwjQvMDh6/icon
            ...
            >
              {p.renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>
                    <Select__Option
                      className={classNames("__wab_instance", sty.option__zUU)}
                      value={"value1" as const}
                    >
                      {"Option 1"}
                    </Select__Option>
                    <Select__Option
                      className={classNames("__wab_instance", sty.option__lmpZ)}
