...
import * as sty from "./PlasmicFooterBlack.module.css"; // plasmic-import: ZHEEWdUtcSn4AC/css

import HabistackLogosvgIcon from "./icons/PlasmicIcon__HabistackLogosvg"; // plasmic-import: ngqfedQNMj8x5p/icon
import blog01390X290Jpg2GoAw8JORopVTfZ from "./images/blog01390X290Jpg2.jpg"; // plasmic-import: GOAw8jORopVTfZ/picture
import blog4390X290Jpg2Yvs9Kc17MnQpi0 from "./images/blog4390X290Jpg2.jpg"; // plasmic-import: YVS9kc17MnQPI0/picture
import blog2390X290Jpg2HxRGkqCiEh09G from "./images/blog2390X290Jpg2.jpg"; // plasmic-import: HxRGkqCI_Eh09G/picture
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.columns__nr6CJ)}>
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.column__xrWoZ)}
            >
            ...
            <div className={classNames(projectcss.all, sty.column___1F2)}>
              <h5
                className={classNames(
                  projectcss.all,
                  projectcss.h5,
            ...
            <div className={classNames(projectcss.all, sty.column__gdWw8)}>
              <h5
                className={classNames(
                  projectcss.all,
                  projectcss.h5,
              ...
              <div className={classNames(projectcss.all, sty.columns__bTrZw)}>
                <div className={classNames(projectcss.all, sty.column__whz9C)}>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__mQjjo)}
                    ...
                    src={{
                      src: blog01390X290Jpg2GoAw8JORopVTfZ,
                      fullWidth: 390,
                      fullHeight: 290,
                ...
                <div className={classNames(projectcss.all, sty.column__gvyCz)}>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__cgglx)}
                    displayHeight={"auto" as const}
                    displayMaxHeight={"none" as const}
                    displayMaxWidth={"100%" as const}
                    displayMinHeight={"0" as const}
                    ...
                    loading={"lazy" as const}
                    src={{
                      src: blog4390X290Jpg2Yvs9Kc17MnQpi0,
                      fullWidth: 390,
                      fullHeight: 290,
                      aspectRatio: undefined
                    }}
                ...
                <div className={classNames(projectcss.all, sty.column__dg9Fi)}>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__nf478)}
                    displayHeight={"auto" as const}
                    displayMaxHeight={"none" as const}
                    displayMaxWidth={"100%" as const}
                    displayMinHeight={"0" as const}
                    ...
                    loading={"lazy" as const}
                    src={{
                      src: blog2390X290Jpg2HxRGkqCiEh09G,
                      fullWidth: 390,
                      fullHeight: 290,
                      aspectRatio: undefined
                    }}
              ...
              <div className={classNames(projectcss.all, sty.columns__yehTp)}>
                <div className={classNames(projectcss.all, sty.column__hjkEk)}>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__bsXSt)}
                    displayHeight={"auto" as const}
                    displayMaxHeight={"none" as const}
                    displayMaxWidth={"100%" as const}
                    displayMinHeight={"0" as const}
                ...
                <div className={classNames(projectcss.all, sty.column__mkMbM)}>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__uzBpz)}
                    displayHeight={"auto" as const}
                    displayMaxHeight={"none" as const}
                    displayMaxWidth={"100%" as const}
                    displayMinHeight={"0" as const}
                ...
                <div className={classNames(projectcss.all, sty.column__o7WDy)}>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__ospa1)}
                    displayHeight={"auto" as const}
                    displayMaxHeight={"none" as const}
                    displayMaxWidth={"100%" as const}
                    displayMinHeight={"0" as const}
