...
import * as sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: z22IV59uvDRM56/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: e1WdP4WwrwenvD/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__aw794)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__yi5C)}
              />
            </React.Fragment>
          ),
          value: args.children
