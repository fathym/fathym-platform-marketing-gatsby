...
import * as sty from "./PlasmicCheckbox.module.css"; // plasmic-import: Q5laXs2gczfJL9/css

import SquaresvgIcon from "./icons/PlasmicIcon__Squaresvg"; // plasmic-import: tsmuk6Hr9weeRq/icon
import SquareCheckFilledsvgIcon from "./icons/PlasmicIcon__SquareCheckFilledsvg"; // plasmic-import: kePbo0V8-OvrEJ/icon
import SquareMinussvgIcon from "./icons/PlasmicIcon__SquareMinussvg"; // plasmic-import: oWTznmp2JFVMSX/icon
