...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: dml3-k3oKyCB7V/css

import smalljpg8TGhpYtzTqVhL4 from "./images/smalljpg.jpg"; // plasmic-import: 8TGhpYTZTqVhL4/picture
...
function PlasmicTestimonial__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.column___4Xt3K)}>
        <h2
        ...
        >
          <div className={classNames(projectcss.all, sty.column__sn11J)}>
            <p.PlasmicImg
          ...
          <div className={classNames(projectcss.all, sty.column__mn0M)}>
            <h5
